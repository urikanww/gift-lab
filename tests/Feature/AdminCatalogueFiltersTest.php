...
it('filters by source kind and returns source_kind in the payload', function (): void {
    ...
    Product::factory()->scrapedUv()->create(['name' => 'Shp', 'publish_state' => 'READY_TO_APPROVE', 'source_url' => 'https://shopee.sg/product/1/2', 'source_links' => [['label' => 'S', 'url' => 'https://shopee.sg/product/1/2', 'kind' => 'marketplace', 'price' => 9.9, 'currency' => 'SGD', 'last_checked' => null]]]);
    Product::factory()->scrapedUv()->create(['name' => 'Loc', 'publish_state' => 'READY_TO_APPROVE', 'source_url' => 'https://blankco.sg/mug', 'source_links' => [['label' => 'L', 'url' => 'https://blankco.sg/mug', 'kind' => 'local', 'price' => 9.9, 'currency' => 'SGD', 'last_checked' => null]]]);
...
it('filters by print method', function (): void {
    Product::factory()->scrapedUv()->create(['name' => 'UvOne', 'publish_state' => 'READY_TO_APPROVE', 'print_method' => 'UV']);
    Product::factory()->model3d()->create(['name' => 'FdmOne', 'publish_state' => 'READY_TO_APPROVE', 'print_method' => 'FDM']);
...
it('filters missing buy link (SCRAPED_UV with no source_links)', function (): void {
    Product::factory()->scrapedUv()->create(['name' => 'HasLink', 'publish_state' => 'READY_TO_APPROVE', 'source_links' => [['label' => 'S', 'url' => 'https://x.sg/1', 'kind' => 'local', 'price' => 1.0, 'currency' => 'SGD', 'last_checked' => null]]]);
    Product::factory()->scrapedUv()->create(['name' => 'NoLink', 'publish_state' => 'READY_TO_APPROVE', 'source_links' => []]);
